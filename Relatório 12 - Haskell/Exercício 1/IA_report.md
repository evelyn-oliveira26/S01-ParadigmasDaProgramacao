...
**Prompt 6:**
> como funciona a sintaxe para criar uma linha dessas com o let dentro do main? Como eu passo os valores para o construtor um do lado do outro?
...
**Resposta do prompt 6:** A IA me explicou que para guardar um valor no main a gente usa let nome = Construtor. Ela me mostrou que os valores são passados em sequência, separados apenas por um espaço. Também me alertou que se o construtor pedir uma lista, eu preciso colocar o elemento entre colchetes, mesmo que seja para passar um item só.
